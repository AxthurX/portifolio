			...
			<Card className='col-span-1 border-0 bg-white/10 text-white backdrop-blur-md'>
				...
				<CardFooter className='flex justify-between'>
					...
					<Dialog>
						...
						<DialogContent className='border-gray-700 bg-gray-800/90 text-white backdrop-blur-md'>
							<DialogHeader>
									...
									<Popover>
										<PopoverTrigger asChild>
											<Button
												variant='outline'
												className={cn(
													'w-full justify-start border-gray-700 bg-white/10 text-left font-normal text-white',
