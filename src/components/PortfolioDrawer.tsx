				...
				<>
					...
					>
						...
						<div className='flex shrink-0 items-center justify-between border-border border-b px-6 pt-6 pb-4 md:px-10'>
							<div>
								<span className='mb-1 block text-muted-foreground text-xs font-medium uppercase tracking-widest'>
									Portfolio
								</span>
							...
							>
								...
								<SliderBtnGroup className='grid shrink-0 grid-cols-2 gap-2 md:grid-cols-4'>
									{PROJECTS.map((project) => (
										...
										>
											<span className='relative z-10 mb-1 block truncate font-medium text-primary text-[10px] uppercase tracking-widest'>
												{project.category}
											</span>
						...
						<div className='flex shrink-0 justify-center pt-1 pb-4'>
							...
							>
								...
								<span className='text-muted-foreground text-[10px] font-medium uppercase tracking-widest transition-colors duration-300 group-hover:text-primary'>
									fechar
								</span>
							</motion.button>
						</div>
